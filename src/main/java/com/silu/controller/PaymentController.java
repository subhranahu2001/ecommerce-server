...
import com.silu.exception.OrderException;
import com.silu.exception.UserException;
import com.silu.modal.Order;
import com.silu.repository.OrderRepository;
import com.silu.response.ApiResponse;
import com.silu.response.PaymentLinkResponse;
import com.silu.service.OrderService;
import com.silu.service.UserService;
import com.silu.user.domain.OrderStatus;
import com.silu.user.domain.PaymentStatus;
...
//	   @Value("${razorpay.api.key}")
	    private String apiKey = "rzp_test_Smyj5i3wSby5sl" ;//rzp_test_Smyj5i3wSby5sl;

//	    @Value("${razorpay.api.secret}")
	    private String apiSecret ="B9GidSbrwucqgtP5zANugfqU";//B9GidSbrwucqgtP5zANugfqU
